...
//    // $query="update product set pro_name='$product_name', pro_price='$product_price',pro_desc='$product_description',
//      //       pro_image='$product_image',cat_id='$select_category' where pro_id={$_GET['pro_id']}";

//           //  $result=mysqli_query($connection,$query);
//         }

//        // $select="select * from product where pro_id={$_GET['pro_id']}";
