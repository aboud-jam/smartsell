                        ...
                        echo "<div class='col-12 col-sm-6 col-lg-4'>";   
                         echo "<div class='single-product-wrapper'>";       
                              ...
                              echo "<div class='product-img'>";      
                                  echo "<img src=.colours.jpg' alt=''>";      
                                       // <!-- Hover Thumb -->
                                    // echo "<img class='hover-img' src={$key['pro_img']}' alt=''>";   
                                 ...
                                 echo "<div class='product-description'>";   
                                       echo "<span>topshop</span>"; 
                                        echo "<a href='single-product.php?cat_id={$_GET['cat_id']}'>";
                                           echo "<h6>{$key['pro_desc']}</h6>"; 
                                       echo "</a>"; 
                                      echo "<p class='product-price'>{$key['pro_price']}</p>";  
